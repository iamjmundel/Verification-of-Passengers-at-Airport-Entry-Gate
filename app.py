...
mydb = mysql.connector.connect(host='localhost',username='root',password='mysql',charset='utf8',database='tickets2')
mycursor = mydb.cursor()
mycursor.execute("USE tickets2")
...
Airport2=Tk()
Airport2.title("Passenger Verification")
Airport2.geometry("1200x800+0+0")
Airport2.resizable(False,False)
title = Label(Airport2, text="Passenger Verification", font=("times new roman", 50), bg='black', fg='white').place(
            x=0, y=0, relwidth=1)

#button frame
btn_frame=Frame(Airport2,bd=2,relief=RIDGE)
...
#main frame
main_frame = Frame(Airport2, bd=2, bg='WHITE', relief=RIDGE)
